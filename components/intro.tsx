    ...
    >
      ...
      >
        ...
        <a
          ...
          className="flex items-center gap-2 p-3 transition bg-white rounded-full outline-hidden group px-7 focus:scale-110 hover:scale-110 active:scale-105 border-black/10 dark:bg-white/10"
          download
        >
          Download CV{" "}
        ...
        <a
          className=" gap-2 items-center bg-white p-4 text-gray-700 rounded-full outline-hidden focus:scale-110 hover:scale-[1.15] active:scale-[1.15] transition border-black/10 dark:bg-white/10 hover:text-gray-950 dark:text-white/60"
        ...
        <a
          className=" gap-2 items-center bg-white p-3.5 text-gray-700 rounded-full text-[1.35rem] outline-hidden focus:scale-110 hover:scale-[1.15]  active:scale-[1.15] transition border-black/10 dark:bg-white/10 hover:text-gray-950 dark:text-white/60"
